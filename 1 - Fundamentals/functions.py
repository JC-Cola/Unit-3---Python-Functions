...
def calculate_engagement(likes, shares, comments):
    ...
    This  function takes the number or likes, shares and comments on a post and returns the total engagement count.
    
    Args:
        likes (_type_): Number of likes.
        shares (_type_): Number of shares.
        comments (_type_): Number of comments.
        
    Returns:
        int: the total engagement, calculated as the sum of pf likes, shares and comments
